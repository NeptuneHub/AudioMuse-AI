...
| `NEURAL_FINGERPRINT_ENABLED`                | If false, the neural fingerprint stage of the analysis and its index build are skipped and Search by Recording leaves the menu, like `CLAP_ENABLED` and `LYRICS_ENABLED` do for their pages. | `true`                                 |
| **Hyperbolic Explorer**                     |                                                                                            |                                        |
