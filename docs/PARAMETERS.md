...
| `NAVIDROME_USER`     | (Required for password auth) Navidrome / Subsonic username.             | *(N/A - from Secret)* |
| `NAVIDROME_PASSWORD` | (Required for password auth) Navidrome / Subsonic password.             | *(N/A - from Secret)* |
