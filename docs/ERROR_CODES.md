...
| 6011 | Album Creation Error | The Album Creation endpoint or the scheduled Album of the Week task fails | queue, [app_album_creation.py](../app_album_creation.py) | Check the log; confirm analysis ran, the index is loaded and lyrics analysis is enabled. |
