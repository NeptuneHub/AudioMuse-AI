...
NUM_CLUSTERS_MIN = int(os.getenv("NUM_CLUSTERS_MIN", "4"))
...
GMM_N_COMPONENTS_MIN = int(os.getenv("GMM_N_COMPONENTS_MIN", "4"))
...
SPECTRAL_N_CLUSTERS_MIN = int(os.getenv("SPECTRAL_N_CLUSTERS_MIN", "4"))
