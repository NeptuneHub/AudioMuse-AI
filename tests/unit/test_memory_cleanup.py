...
class TestAnalyzeAlbumMemoryCleanup:
    ...
    def test_cleanup_all_models_in_finally(
        self, mock_clap_loaded, mock_clap_unload, mock_get_db, mock_get_job,
        mock_get_task_info, mock_save_task, mock_memory_cleanup, mock_get_tracks
    ):
        """Test that all optional models are cleaned up in the finally block."""
        from tasks.analysis import analyze_album_task
