...
logging.basicConfig(
    level=logging.DEBUG, # Set the default logging level (e.g., INFO, DEBUG, WARNING, ERROR, CRITICAL)
...
auth_configured = bool(config.AUDIOMUSE_USER and config.AUDIOMUSE_PASSWORD)
...
def auth_endpoint():
    ...
    if user != config.AUDIOMUSE_USER or not _verify_audiomuse_password(config.AUDIOMUSE_PASSWORD, password):
