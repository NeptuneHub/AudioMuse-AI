...
def login_page():
    ...
    if AUTH_ENABLED and (not AUDIOMUSE_USER or not AUDIOMUSE_PASSWORD):
        auth_warning = (
            'Authentication is enabled and one or more credentials were autogenerated defaults. '
            'The effective values are printed in the startup log, but you should set AUDIOMUSE_USER and AUDIOMUSE_PASSWORD '
            'in your environment var for stable credentials. Optionally set API_TOKEN if you need external/plugin access.'
        )
