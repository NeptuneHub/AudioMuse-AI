...
from config import JELLYFIN_URL, JELLYFIN_USER_ID, JELLYFIN_TOKEN, HEADERS, TEMP_DIR, \
  ...
  AI_MODEL_PROVIDER, OLLAMA_SERVER_URL, OLLAMA_MODEL_NAME, ATLAS_SERVER_URL, ATLAS_MODEL_NAME, OPENAI_SERVER_URL, OPENAI_MODEL_NAME, GEMINI_API_KEY, GEMINI_MODEL_NAME, MISTRAL_MODEL_NAME, \
...
def get_config_endpoint():
    ...
    return jsonify({
        ...
        "atlas_server_url": config.ATLAS_SERVER_URL, "atlas_model_name": config.ATLAS_MODEL_NAME,
