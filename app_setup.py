...
SECRET_FIELDS = {"AUDIOMUSE_PASSWORD", "API_TOKEN", "JELLYFIN_TOKEN", "EMBY_TOKEN", "NAVIDROME_PASSWORD", "JWT_SECRET", "AI_CHAT_DB_USER_PASSWORD", "LYRICS_API_1_APIKEY_VALUE", "LYRICS_API_2_APIKEY_VALUE", "OPENAI_API_KEY", "ATLAS_API_KEY", "GEMINI_API_KEY", "MISTRAL_API_KEY"}
...
ENUM_FIELD_OPTIONS = {
    'AI_MODEL_PROVIDER': ['NONE', 'OLLAMA', 'OPENAI', 'ATLAS', 'GEMINI', 'MISTRAL'],
